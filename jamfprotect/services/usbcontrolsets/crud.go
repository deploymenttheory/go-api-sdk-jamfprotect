...
func (s *Service) CreateUSBControlSet(ctx context.Context, req *CreateUSBControlSetRequest) (*USBControlSet, *interfaces.Response, error) {
	...
	vars := buildUSBControlSetVariables(req, "")
	var result struct {
		CreateUSBControlSet *USBControlSet `json:"createUSBControlSet"`
	}

	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, createUSBControlSetMutation, vars, &result, headers)
	if err != nil {
...
func (s *Service) GetUSBControlSet(ctx context.Context, id string) (*USBControlSet, *interfaces.Response, error) {
	...
	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, getUSBControlSetQuery, vars, &result, headers)
	if err != nil {
...
func (s *Service) UpdateUSBControlSet(ctx context.Context, id string, req *UpdateUSBControlSetRequest) (*USBControlSet, *interfaces.Response, error) {
	...
	vars := buildUSBControlSetVariables(req, id)
	var result struct {
		UpdateUSBControlSet *USBControlSet `json:"updateUSBControlSet"`
	}

	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, updateUSBControlSetMutation, vars, &result, headers)
	if err != nil {
...
func (s *Service) DeleteUSBControlSet(ctx context.Context, id string) (*interfaces.Response, error) {
	...
	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, deleteUSBControlSetMutation, vars, nil, headers)
	if err != nil {
...
func (s *Service) ListUSBControlSets(ctx context.Context) ([]USBControlSet, *interfaces.Response, error) {
	...
	for {
		...
		resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, listUSBControlSetsQuery, vars, &result, headers)
		lastResp = resp
		if err != nil {
...
// buildUSBControlSetVariables builds the GraphQL variables map from a request struct
func buildUSBControlSetVariables(req any, id string) map[string]any {
	var (
		name                 string
		description          string
