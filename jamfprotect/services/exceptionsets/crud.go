...
func (s *Service) CreateExceptionSet(ctx context.Context, req *CreateExceptionSetRequest) (*ExceptionSet, *interfaces.Response, error) {
	...
	vars := buildExceptionSetVariables(req, "")
	var result struct {
		CreateExceptionSet *ExceptionSet `json:"createExceptionSet"`
	}

	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, createExceptionSetMutation, vars, &result, headers)
	if err != nil {
...
func (s *Service) GetExceptionSet(ctx context.Context, uuid string) (*ExceptionSet, *interfaces.Response, error) {
	...
	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, getExceptionSetQuery, vars, &result, headers)
	if err != nil {
...
func (s *Service) UpdateExceptionSet(ctx context.Context, uuid string, req *UpdateExceptionSetRequest) (*ExceptionSet, *interfaces.Response, error) {
	...
	vars := buildExceptionSetVariables(req, uuid)
	var result struct {
		UpdateExceptionSet *ExceptionSet `json:"updateExceptionSet"`
	}

	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, updateExceptionSetMutation, vars, &result, headers)
	if err != nil {
...
func (s *Service) DeleteExceptionSet(ctx context.Context, uuid string) (*interfaces.Response, error) {
	...
	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, deleteExceptionSetMutation, vars, nil, headers)
	if err != nil {
...
func (s *Service) ListExceptionSets(ctx context.Context) ([]ExceptionSetListItem, *interfaces.Response, error) {
	...
	for {
		...
		resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, listExceptionSetsQuery, vars, &result, headers)
		lastResp = resp
		if err != nil {
...
// buildExceptionSetVariables builds the GraphQL variables map from a request struct
func buildExceptionSetVariables(req any, uuid string) map[string]any {
	var (
		name         string
		description  string
