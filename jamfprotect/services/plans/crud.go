...
func (s *Service) CreatePlan(ctx context.Context, req *CreatePlanRequest) (*Plan, *interfaces.Response, error) {
	...
	vars := buildPlanVariables(req)
	var result struct {
		CreatePlan *Plan `json:"createPlan"`
	}

	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, createPlanMutation, vars, &result, headers)
	if err != nil {
...
func (s *Service) GetPlan(ctx context.Context, id string) (*Plan, *interfaces.Response, error) {
	...
	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, getPlanQuery, vars, &result, headers)
	if err != nil {
...
func (s *Service) UpdatePlan(ctx context.Context, id string, req *UpdatePlanRequest) (*Plan, *interfaces.Response, error) {
	...
	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, updatePlanMutation, vars, &result, headers)
	if err != nil {
...
func (s *Service) DeletePlan(ctx context.Context, id string) (*interfaces.Response, error) {
	...
	resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, deletePlanMutation, vars, nil, headers)
	if err != nil {
...
func (s *Service) ListPlans(ctx context.Context) ([]Plan, *interfaces.Response, error) {
	...
	for {
		...
		resp, err := s.client.DoGraphQL(ctx, client.EndpointApp, listPlansQuery, vars, &result, headers)
		lastResp = resp
		if err != nil {
...
// buildPlanVariables builds the GraphQL variables map from a request struct
func buildPlanVariables(req any) map[string]any {
	var (
		name                 string
		description          string
		logLevel             *string
